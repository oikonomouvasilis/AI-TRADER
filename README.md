...
2. **Receptivity check** (`risk` + `agent`) — account snapshot, one Claude decision call
...
`ALPACA_API_KEY`, `ALPACA_SECRET_KEY`, `ANTHROPIC_API_KEY`, `FINNHUB_API_KEY`.
Optional var `ANTHROPIC_MODEL` (default `claude-sonnet-4-6`).
